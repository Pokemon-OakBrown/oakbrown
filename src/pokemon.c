...
u32 GenerateDexMonPersonality(u16 species, bool8 shiny)
{
    ...
    while ((gBaseStats[species].genderRatio < MON_FEMALE && GetGenderFromSpeciesAndPersonality(species, personality) != MON_MALE)
        ...
        || IsShinyOtIdPersonality(8, personality) != shiny);
...
u32 GetBoxMonData(struct BoxPokemon *boxMon, s32 field, u8 *data)
{
    ...
    case MON_DATA_ABILITY_NUM:
        retVal = boxMon->personality % 2
            && (gBaseStats[boxMon->species].abilities[1] != ABILITY_NONE);
        break;
...
bool8 PokemonUseItemEffects(struct Pokemon *mon, u16 item, u8 partyIndex, u8 moveIndex, u8 e)
{
    ...
    if (heldItem == ITEM_ENIGMA_BERRY)
    {
        if (gMain.inBattle)
            ...
            holdEffect = gSaveBlock2Ptr->enigmaBerry.holdEffect;
    }
    else
    {
    ...
    if (item == ITEM_ENIGMA_BERRY)
    {
        if (gMain.inBattle)
            ...
            itemEffect = gSaveBlock2Ptr->enigmaBerry.itemEffect;
    }
    else
    {
