...
static const u8 sTextColorTable[] =
{
 // [LOW_NYBBLE / 2]                            = 0xXY, // HIGH_NYBBLE
    ...
    [OBJ_EVENT_GFX_ROCKET_M_2 / 2]              = 0x10, // OBJ_EVENT_GFX_LASS_2
    [OBJ_EVENT_GFX_FIRE_BREATHER / 2]           = 0x00, // OBJ_EVENT_GFX_SCIENTIST_2
    [OBJ_EVENT_GFX_COWGIRL / 2]                 = 0x11, // OBJ_EVENT_GFX_SWIMMER_F_2_LAND
    [OBJ_EVENT_GFX_SWIMMER_F_2_WATER / 2]       = 0x01, // OBJ_EVENT_GFX_COLLECTOR
    [OBJ_EVENT_GFX_GENTLEMAN_2 / 2]             = 0x00, // OBJ_EVENT_GFX_CAMPER_2
    [OBJ_EVENT_GFX_PICNICKER_2 / 2]             = 0x01, // OBJ_EVENT_GFX_GUITARIST
    [OBJ_EVENT_GFX_RANGER_M / 2]                = 0x10, // OBJ_EVENT_GFX_RANGER_F
    ...
    [OBJ_EVENT_GFX_POKEMANIAC_2 / 2]            = 0x10, // OBJ_EVENT_GFX_BEAUTY_2
    [OBJ_EVENT_GFX_BOY_2 / 2]                   = 0x00, // OBJ_EVENT_GFX_BOY_3
    [OBJ_EVENT_GFX_CLERK_2 / 2]                 = 0x00, // OBJ_EVENT_GFX_FAT_MAN_3
    [OBJ_EVENT_GFX_LASS_3 / 2]                  = 0x01, // OBJ_EVENT_GFX_LITTLE_BOY_2
