...
const u8 gTypeEffectiveness[573] =
{
    TYPE_NORMAL, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NORMAL, TYPE_STEEL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NORMAL, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_NORMAL, TYPE_ABNORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_FIRE, TYPE_WIND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIRE, TYPE_GAS, TYPE_MUL_ULTRA_EFFECTIVE,
    TYPE_FIRE, TYPE_WOOD, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_WATER, TYPE_SOUND, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_ELECTRIC, TYPE_WOOD, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_FIGHTING, TYPE_GAS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FIGHTING, TYPE_WOOD, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_GROUND, TYPE_WOOD, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_FLYING, TYPE_WIND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_FLYING, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FLYING, TYPE_GAS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_FLYING, TYPE_ABNORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_PSYCHIC, TYPE_ABNORMAL, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_BUG, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_BUG, TYPE_WOOD, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_ROCK, TYPE_WIND, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_GHOST, TYPE_WIND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GHOST, TYPE_SOUND, TYPE_MUL_NO_EFFECT,
    TYPE_GHOST, TYPE_GAS, TYPE_MUL_SUPER_EFFECTIVE,
    ...
    TYPE_DRAGON, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_DARK, TYPE_SOUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_DARK, TYPE_ABNORMAL, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_STEEL, TYPE_SOUND, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_STEEL, TYPE_ABNORMAL, TYPE_MUL_NOT_EFFECTIVE,
    ...
    TYPE_WIND, TYPE_FIGHTING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WIND, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WIND, TYPE_GROUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WIND, TYPE_ROCK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WIND, TYPE_GHOST, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WIND, TYPE_FIRE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WIND, TYPE_GRASS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WIND, TYPE_GAS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WIND, TYPE_WOOD, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_SOUND, TYPE_NORMAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_SOUND, TYPE_FIGHTING, TYPE_MUL_NO_EFFECT,
    ...
    TYPE_GAS, TYPE_FIGHTING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAS, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_GAS, TYPE_GHOST, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAS, TYPE_FIRE, TYPE_MUL_ULTRA_EFFECTIVE,
    TYPE_GAS, TYPE_PSYCHIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_GAS, TYPE_WIND, TYPE_MUL_NO_EFFECT,
    TYPE_GAS, TYPE_GAS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WOOD, TYPE_FLYING, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WOOD, TYPE_POISON, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WOOD, TYPE_ROCK, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WOOD, TYPE_BUG, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WOOD, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WOOD, TYPE_FIRE, TYPE_MUL_NO_EFFECT,
    TYPE_WOOD, TYPE_WATER, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WOOD, TYPE_GRASS, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WOOD, TYPE_ELECTRIC, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WOOD, TYPE_ICE, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_WOOD, TYPE_WIND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_WOOD, TYPE_GAS, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_NORMAL, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_FLYING, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_BUG, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_STEEL, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_PSYCHIC, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_DARK, TYPE_MUL_SUPER_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_SOUND, TYPE_MUL_NOT_EFFECTIVE,
    TYPE_ABNORMAL, TYPE_ABNORMAL, TYPE_MUL_SUPER_EFFECTIVE,
...
static void SetPlayerBerryDataInBattleStruct(void)
{
    ...
    if (IsEnigmaBerryValid() == TRUE)
    {
        for (i = 0; i < BERRY_NAME_LENGTH; ++i)
            battleBerry->name[i] = gSaveBlock2Ptr->enigmaBerry.berry.name[i];
        battleBerry->name[i] = EOS;
        for (i = 0; i < BERRY_ITEM_EFFECT_COUNT; ++i)
            battleBerry->itemEffect[i] = gSaveBlock2Ptr->enigmaBerry.itemEffect[i];
        battleBerry->holdEffect = gSaveBlock2Ptr->enigmaBerry.holdEffect;
        battleBerry->holdEffectParam = gSaveBlock2Ptr->enigmaBerry.holdEffectParam;
    }
    else
    {
...
static void SetAllPlayersBerryData(void)
{
    ...
    if (!(gBattleTypeFlags & BATTLE_TYPE_LINK))
    {
        if (IsEnigmaBerryValid() == TRUE)
        {
            for (i = 0; i < BERRY_NAME_LENGTH; ++i)
            {
                gEnigmaBerries[0].name[i] = gSaveBlock2Ptr->enigmaBerry.berry.name[i];
                gEnigmaBerries[2].name[i] = gSaveBlock2Ptr->enigmaBerry.berry.name[i];
            }
            gEnigmaBerries[0].name[i] = EOS;
            gEnigmaBerries[2].name[i] = EOS;
            for (i = 0; i < BERRY_ITEM_EFFECT_COUNT; ++i)
            {
                gEnigmaBerries[0].itemEffect[i] = gSaveBlock2Ptr->enigmaBerry.itemEffect[i];
                gEnigmaBerries[2].itemEffect[i] = gSaveBlock2Ptr->enigmaBerry.itemEffect[i];
            }
            gEnigmaBerries[0].holdEffect = gSaveBlock2Ptr->enigmaBerry.holdEffect;
            gEnigmaBerries[2].holdEffect = gSaveBlock2Ptr->enigmaBerry.holdEffect;
            gEnigmaBerries[0].holdEffectParam = gSaveBlock2Ptr->enigmaBerry.holdEffectParam;
            gEnigmaBerries[2].holdEffectParam = gSaveBlock2Ptr->enigmaBerry.holdEffectParam;
        }
        else
        {
            const struct Berry *berryData = GetBerryInfo(ItemIdToBerryType(ITEM_ENIGMA_BERRY));
...
static u8 CreateNPCTrainerParty(struct Pokemon *party, u16 trainerNum)
{
    ...
    // Seed rng based on trainer number, then get a new seed for each party member.
    rngOld = gRngValue;
